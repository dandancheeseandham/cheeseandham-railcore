...
;Leadscrew locations
M671 X-10:-10:333 Y22.5:277.5:150 S10 ;Front left,(-10,22.5) Rear Left (-10.,227.5) , Right (333,160) S10 is the max correction - measure your own offsets, to the bolt for the yoke of each leadscrew

; Axis and motor configuration
M350 X16 Y16 Z16 E16 I1                 ; Set 16x microstepping for axes & extruder, with interpolation.
M574 X1 Y1 S1                           ; Set homing switch configuration (x,y at min, z at max) IF YOU NEED TO REVERSE YOUR HOMING SWITCHES CHANGE S1 to S0
...
; Thermistors
M305 P0 S"Bed" T100000 B3950 R4700 H0 L0 X6       ; BOM thermistor values. Put your own H and/or L values here to set the bed thermistor ADC correction
...
M98 P"/sys/config-user.g"               ; Load custom user config
